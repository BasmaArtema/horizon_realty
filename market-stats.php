...
<!--
  ...
  Date: 2026-03-26
  Notes:
    - This is the Luxury Estates listings page for Horizon Realty, featuring high-end properties with golf course, lake, and waterfront views, as well as premium finishes and garage options.
-->
...
<div class="top-auth-bar">
    ...
    <main class="house-price-container">
        <h2 class="house-price-title">MARKET STATS — EXCHANGE RATES</h2>
            ...
            <div class="converter-section">
                ...
                <div class="converter-card">
                    ...
                    <div class="common-conversions" id="commonConversions">
                        <div class="conversion-item"><span>CAD → USD</span><span id="cadUsd">—</span></div>
                        <div class="conversion-item"><span>CAD → EUR</span><span id="cadEur">—</span></div>
                        <div class="conversion-item"><span>CAD → GBP</span><span id="cadGbp">—</span></div>
                    </div>
                </div>
            </div>
        </div>
