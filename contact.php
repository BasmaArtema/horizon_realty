...
<!--
  ...
  Date: 2026-03-26
  Notes:
    - This is the Contact Us page for Horizon Realty, providing a contact form and office information for inquiries and appointments.
-->
    ...
    <div class="contact-grid">
        ...
        <div class="contact-box">
            <form class="contact-form" id="contactForm">
                ...
                <textarea placeholder="Your Message" rows="5" class="form-input" required></textarea>
                <button type="submit" class="form-button">Send Message</button>
            </form>
        </div>

        <!-- OFFICE INFO BOX -->
        <div class="contact-box visit-card">
            <h3>Visit Our Office</h3>
            <p class="bold" style="color:#2C3E50;">Horizon Realty</p>
            <p style="color:#2C3E50;" >101 Main Street<br>Windsor, ON N9A 1B2<br>Canada</p>

            <p class="bold" style="color:#2C3E50;">Contact Us</p>
            <p style="color:#2C3E50;">+1 (519) 555-0199<br>info@horizonrealty.ca</p>

            <p class="bold" style="color:#2C3E50;">Opening Hours</p>
            <p style="color:#2C3E50;">Mon-Fri: 9AM - 6PM<br>Sat: 10AM - 4PM</p>
        </div>
