...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Learn how admins manage users, listings, and monitoring tools in Horizon Realty.">
...
<div class="help-container">
    <aside class="help-sidebar">
        ...
        <ul class="help-menu">
            ...
            <li><a href="wiki-admin.php" class="active">Admin Guide</a></li>
        </ul>
    </aside>
    <section class="help-section">
        <h2>Admin Guide</h2>
        <h3>Managing Listings</h3>
        <p>Admin users can open <code>admin-listings.php</code> to review all property records and use <code>edit-listing.php</code> to update prices, addresses, images, and listing details.</p>
        <h3>Managing Users</h3>
        <p>The <code>admin-users.php</code> page allows admins to review accounts and enable or disable user access.</p>
        <h3>Monitoring The Site</h3>
        <p>The <code>monitor.php</code> page reports the status of the database connection, core tables, and major website pages.</p>
    </section>
</div>
</main>
<footer>
